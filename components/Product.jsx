...
export default function Product({ product }) {
    return (
        <div
            key={product.id}
            className="group relative bg-white border border-gray-200 rounded-2xl p-5 shadow-md hover:shadow-2xl hover:shadow-blue-200/50 transition-all duration-300 hover:-translate-y-2 overflow-hidden"
        >
