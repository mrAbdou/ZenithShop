        ...
        <section className="bg-white rounded-xl shadow-sm border border-gray-200/80 p-6 md:p-8 mb-6">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div className="flex items-center justify-between border-b border-gray-200/80 pb-4">
                    <div>
                        <h2 className="text-2xl font-bold text-gray-900">{t('admin.categories.filterCategories')}</h2>
                        <p className="text-sm text-gray-500 mt-1">{t('admin.categories.searchAndFilter')}</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                    ...
                    <div className="space-y-2">
                        <label htmlFor="searchQuery" className="block text-sm font-semibold text-gray-700">
                            {t('admin.categories.searchCategories')}
                        </label>
                        <div className="relative">
                            ...
                            <input
                                ...
                                placeholder={t('admin.categories.searchByName')}
                ...
                <div className="flex items-center justify-between pt-2 border-t border-gray-200/80">
                    <p className="text-sm text-gray-500">
                        {t('admin.categories.refineSearch')}
                    </p>
                    <button
                        disabled={!isValid}
                        type="submit"
                    ...
                    >
                        ...
                        {t('admin.categories.applyFilters')}
                    </button>
                </div>
            </form>
        </section>
