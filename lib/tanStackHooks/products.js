...
const useProducts = async (limit = LIMIT, offset = 0) => {
    ...
    console.log('from lib/tanStackHooks/products.js products : ', products);
    return products || [];
}

//get the details of a product by id
const useProduct = async (id) => {
    console.log('from lib/tanStackHooks/products.js id : ', id);
    ...
    console.log('from lib/tanStackHooks/products.js product : ', product);
    return product || null;
}
...
const useProductsInCart = async (cart) => {
    console.log('in useProductsInCart cart : ', cart);
    ...
    console.log('form lib/tanStackHooks/products.js productsInCart : ', productsInCart);
