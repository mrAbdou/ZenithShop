...
export const OrderFilterSchema = z.object({
    ...
    searchQuery: z
        ...
        .regex(/^[\u0600-\u06FF\u0750-\u077F\u08A0-\u08FF\uFB50-\uFDFF\uFE70-\uFEFF\u00C0-\u00FF\u0100-\u017Fa-zA-Z0-9\s\-'',\.\?!:;]+$/, {
            message: 'Search query can only contain letters (English, French, Arabic), numbers, spaces, and basic punctuation (hyphens, apostrophes, commas, periods, question marks, exclamation marks, colons, semicolons)'
        })
    ...
    currentPage: z
        ...
        .min(1, 'Current page must be greater than 0')
        .optional(),
    limit: z
        .number('Limit should be a number')
        .min(5, 'Pagination limit must be greater than 5')
        .max(20, 'Pagination limit must be less than 20')
        .optional(),
})
