...
export default function CustomerProductsFilters({ initialCategories, translations }) {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
            <h2 className="text-xl font-semibold text-gray-800 mb-6">{translations.filterProducts}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            id="searchQuery"
                            placeholder={translations.searchProductsPlaceholder}
