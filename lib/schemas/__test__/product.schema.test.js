...
describe('Create Product Schema Test', () => {
    describe('Required fields', () => {
        describe('Name filed', () => {
            ...
            it('should validate invalid to create product with wrong name length', () => {
                const result = AddProductSchema.safeParse({
                    name: 'P',
                    price: 99.99,
                    qteInStock: 10,
            ...
            it('should validate valid to create product with string name value that has special characters inside', () => {
                const result = AddProductSchema.safeParse({
                    name: 'Product!@# 1',
                    price: 99.99,
                    qteInStock: 10,
        ...
        describe('Price field', () => {
            ...
            it('should validate valid to create product with string price value', () => {
                const result = AddProductSchema.safeParse({
                    name: 'Product 1',
                    description: 'Description of product 1',
                    price: '123',
    ...
    describe('Optional fields', () => {
        describe('Description field', () => {
            it('should validate valid full product object with provided description', () => {
                const result = AddProductSchema.safeParse({
                    name: 'Product 1',
                    description: 'Description of product 1',
                    price: 99.99,
            ...
            it('should validate valid full product object without provided description', () => {
                const result = AddProductSchema.safeParse({
                    name: 'Product 1',
                    price: 99.99,
                    qteInStock: 10,
...
describe('Update Product Schema test', () => {
    describe('Optional Fields', () => {
        describe('Name field', () => {
            ...
            it('should validate invalid to update name with wrong value length', () => {
                const result = UpdateProductSchema.safeParse({
                    name: 'P'
                })
                expect(result.success).toBe(false)
            ...
            it('shoudl validate valid for updating name with string value that has special characters', () => {
                const result = UpdateProductSchema.safeParse({
                    name: 'product@01'
                })
                expect(result.success).toBe(true)
        ...
        describe('Description Field', () => {
            ...
            it('should validate valid to update description with string text that has special characters', () => {
                const result = UpdateProductSchema.safeParse({
        ...
        describe('Price Field', () => {
            ...
            it('should validate invalid to update price with string alphabetic value', () => {
                ...
                console.log('validation of updating price with string alphabetic value', result.error.issues[0].message)
                expect(result.success).toBe(false)
