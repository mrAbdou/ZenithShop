                    ...
                    <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
                        <div className="flex items-center mb-4">
                            ...
                            <div className="ml-3">
                                ...
                                <p className="text-sm text-gray-500">Are you sure you want to delete this order?</p>
                            </div>
                        </div>

                        <div className="mb-4">
                            <p className="text-sm text-gray-700">
                                Order ID: <span className="font-semibold">{orderToDelete.id.slice(-8)}</span>
                            </p>
                            <p className="text-sm text-gray-700">
                                Customer: <span className="font-semibold">{orderToDelete.user.name}</span>
                            </p>
                            <p className="text-sm text-gray-700">
                                Total: <span className="font-semibold">${orderToDelete.total}</span>
                            </p>
