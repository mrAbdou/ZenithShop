        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
            <div className="max-w-7xl mx-auto p-6 md:p-10">
                ...
                <nav className="text-sm text-gray-500 mb-8">
                    <Link href="/control-panel" className="hover:text-blue-600 transition-colors">Control Panel</Link>
                    <span className="mx-2 text-gray-400">→</span>
                    <Link href="/control-panel/orders" className="hover:text-blue-600 transition-colors">Orders</Link>
                    <span className="mx-2 text-gray-400">→</span>
                    <span className="text-gray-800 font-medium">Order #{order.id.slice(-8)}</span>
                </nav>
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
                            <div className="flex-1">
                                ...
                                <p className="text-blue-50/90 max-w-2xl leading-relaxed">
                                    Comprehensive view of customer order with items, pricing, and fulfillment status.
                                </p>
                            </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                            ...
                            <div className="p-6 space-y-4">
                                ...
                                <div className="flex items-center justify-between py-3 border-b border-gray-100">
                                    ...
                                    <span className="text-sm font-semibold text-gray-900">{order.user.phoneNumber || 'Not provided'}</span>
                                </div>
                                <div className="flex items-start justify-between py-3">
                                    <span className="text-sm font-medium text-gray-500 mr-4">Address</span>
                                    <span className="text-sm font-semibold text-gray-900 text-right leading-relaxed">{order.user.address || 'Not provided'}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="bg-gradient-to-r from-purple-500 to-pink-600 p-6">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-purple-100 text-sm">Detailed breakdown of purchased products</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="mt-8 border-t border-gray-200 pt-6">
                                    <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <h4 className="text-lg font-bold text-gray-900">Order Total</h4>
                            ...
                            <div className="p-6">
                                <div className="space-y-3">
                                    ...
                                    <p className="text-xs text-gray-500 text-center">
                                        Modify order status and processing stage
                                    </p>
                                </div>
                            </div>
                        </div>
