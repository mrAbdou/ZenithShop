...
export const metadata = {
    title: "Categories Management | ZenithShop Admin",
    description: "Manage product categories in your ZenithShop catalog. View, filter, and organize categories through this admin interface.",
};
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        <div className="flex-1">
                            ...
                            <p className="text-purple-50 max-w-2xl">
                                Manage all product categories, filter by name, and view category details. Keep your inventory organized and easy to navigate.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-start md:items-end gap-4">
                            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                                <div className="text-center">
                                    ...
                                    <p className="text-purple-100 text-sm">Management</p>
                                </div>
                            </div>
                        </div>
                    </div>
